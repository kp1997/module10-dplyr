# Exercise 1: Data Frame Practice `````q1`
...
num.manu <- unique(makes)

# Filter the data set for vehicles manufactured in 1997
ninety.seven <- vehicles[vehicles$year == '1997', ]
...
vehciles <- vehicles[order(ninety.seven$hwy), ]
...
new.set <- vehicles[vehicles$drive == '2-Wheel Drive' & vehicles$cty > 20,]
